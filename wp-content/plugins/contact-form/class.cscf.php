...
class cscf
{
    ...
    {    
        ...
        load_plugin_textdomain('contactform', false, $path );
    }
    
    function RegisterScripts() 
    {
        wp_register_script('jquery-validate', 'https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.11.0/jquery.validate.min.js', array(
            'jquery'
        ) , '1.11.0', true);
        wp_register_script( 'cscf-validate', CSCF_PLUGIN_URL . "/js/jquery.validate.contact.form.min.js", 
            'jquery', 
    ...
    */
    ...
    function SettingsLink($links, $file) 
    {
        ...
        if ($file == CSCF_PLUGIN_NAME . '/' . CSCF_PLUGIN_NAME . '.php') 
        {
            ...
            */
            $in = '<a href="options-general.php?page=contact-form-settings">' . __('Settings', 'contactform') . '</a>';
