...
if (!function_exists('nickriddel_scripts')) :
  function nickriddel_scripts() {
    ...
    wp_register_script( 'jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js', array(), '1.11.2', false );
    ...
    wp_register_script( 'jquery-blockui', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.blockUI/2.61.0-2013.06.06/jquery.blockUI.min.js', array( 'jquery' ), '2.61.0', true );
    wp_register_script( 'jquery-payment', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.payment/1.2.1/jquery.payment.min.js', array( 'jquery' ), '1.2.1', true );
