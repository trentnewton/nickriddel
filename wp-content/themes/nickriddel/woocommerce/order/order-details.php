...
?>
<h2 class="fade-in-right"><?php _e( 'Order Details', 'woocommerce' ); ?></h2>
<table class="shop_table order_details fade-in-left">
	<thead>
		<tr>
...
<header>
	<h2 class="fade-in-right"><?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
<table class="shop_table shop_table_responsive customer_details fade-in-left">
<?php
