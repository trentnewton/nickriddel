...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<h2 class="fade-in-up"><?php _e( 'Cart Totals', 'woocommerce' ); ?></h2>

	<table class="fade-in-up shop_table shop_table_responsive">
	...
	<div class="wc-proceed-to-checkout fade-in-up">
